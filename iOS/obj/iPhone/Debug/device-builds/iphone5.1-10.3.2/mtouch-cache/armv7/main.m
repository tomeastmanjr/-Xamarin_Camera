...
extern void *mono_aot_module_toms_camera_test_iOS_info;
...
{
	mono_aot_register_module (mono_aot_module_toms_camera_test_iOS_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "toms_camera_test.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
